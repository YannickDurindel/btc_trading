...
password = "NotSafePwd"
message = "irl_btctrading-V93.4-futures \n"
print("TO THE MOON !!!\n")
...
while True :
    try :
        ...
        if btc_newprice > btc_prevprice*1.005 and  btc_wallet == False and btc_newprice*1.004<btc_max :
        ...
        elif btc_newprice*1.005 < btc_max and btc_wallet == True and btc_newprice > btc_min*1.004:
