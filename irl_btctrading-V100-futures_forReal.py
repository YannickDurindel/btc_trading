...
while True :
    try :
        ...
        if btc_wallet == True and btc_newprice*1.005 < btc_prevprice and btc_newprice > btc_min*1.003 :
            (btc_wallet,btc_prevprive,btc_max) = buy(btc_wallet,btc_buysell,btc_newprice)

        elif btc_wallet == False and btc_newprice > btc_prevprice*1.005 and btc_newprice*1.002 < btc_max :
            (btc_wallet,btc_prevprice,btc_min,btc_buysell) = sell(btc_wallet,btc_buysell,btc_newprice,wallet)
        ...
        elif btc_wallet == False and btc_newprice*1.04 < btc_prevprice :
