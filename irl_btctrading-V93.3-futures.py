...
password = "NotSafePwd"
message = "irl_btctrading-V93.3-futures \n"
print("TO THE MOON !!!\n")
...
while True :
    try :
        ...
        if btc_newprice > btc_prevprice*1.005 and  btc_wallet == False and btc_newprice*1.003<btc_max :
        ...
        elif btc_newprice*1.005 < btc_max and btc_wallet == True and btc_newprice > btc_min*1.003:
        ...
        if btc_wallet == False:
            while btc_newprice > btc_prevprice and btc_newprice>btc_max*1.003 :
                binance_client.futures_create_order(symbol='BTCUSDT',type='MARKET',side='SELL',quantity=btc_buysell)
                print("sell")
                message += str(counter)+" - sell, wallet = "+str(getwallet("USDT"))+", btc price = "+str(btc_newprice)+"\n"
                btc_prevprice = btc_newprice
