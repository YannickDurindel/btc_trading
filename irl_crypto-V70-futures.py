...
# -*- coding: utf-8 -*-
"""
Created on Fri Mar 18 12:35:27 2022
...
while True :
    try :
        ...
        elif (btc_newprice*1.002 < btc_prevprice and btc_wallet == True) or (btc_wallet == "unactivated" and btc_newprice*1.002 < btc_prevprice):
            if btc_crisis == False:
                t1 = time.time()
        ...
        if eth_newprice > eth_prevprice*1.002 and eth_wallet == False:
            ...
            with open('performances.csv', 'a', newline='') as P:  
                ...
                P.close()
            btc_buysell = round((wallet/10)*leverage/btc_newprice,3)
        elif (eth_newprice*1.002 < eth_prevprice and eth_wallet == True) or (eth_wallet == "unactivated" and eth_newprice*1.002 < eth_prevprice):
            if eth_crisis == False:
                t1 = time.time()
        ...
        if xrp_newprice > xrp_prevprice*1.002 and xrp_wallet == False:
            ...
            with open('performances.csv', 'a', newline='') as P:  
                ...
                P.close()
            xrp_buysell = round((wallet/10)*leverage/xrp_newprice,1)
        elif (xrp_newprice*1.002 < xrp_prevprice and xrp_wallet == True) or (xrp_wallet == "unactivated" and xrp_newprice*1.002 < xrp_prevprice):
            if xrp_crisis == False:
                t1 = time.time()
        ...
        if ada_newprice > ada_prevprice*1.002 and ada_wallet == False:
            ...
            with open('performances.csv', 'a', newline='') as P:  
                ...
                P.close()
            ada_buysell = round((wallet/10)*leverage/ada_newprice,0)
        elif (ada_newprice*1.002 < ada_prevprice and ada_wallet == True) or (ada_wallet == "unactivated" and ada_newprice*1.002 < ada_prevprice):
            if ada_crisis == False:
                t1 = time.time()
        ...
        if bnb_newprice > bnb_prevprice*1.002 and bnb_wallet == False:
            ...
            with open('performances.csv', 'a', newline='') as P:  
                ...
                P.close()
            bnb_buysell = round((wallet/10)*leverage/bnb_newprice,2)
        elif (bnb_newprice*1.002 < bnb_prevprice and bnb_wallet == True) or (bnb_wallet == "unactivated" and bnb_newprice*1.002 < bnb_prevprice):
            if bnb_crisis == False:
                t1 = time.time()
