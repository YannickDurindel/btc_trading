...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr  7 17:06:00 2022
...
while True :
    try :
        ...
        if btc_newprice > btc_prevprice*1.005 and  btc_wallet == False and trend_short < 1 and trend_middle < 0.5 and trend_long < 0.1 :
        ...
        elif btc_newprice*1.005 < btc_max and btc_wallet == True and trend_short > -1 and trend_middle > -0.5 and trend_long > -0.1 :
        ...
        if btc_wallet == False:
            while btc_newprice > btc_prevprice and trend_short < 1 and trend_middle < 0.5 and trend_long < 0.1 : 
                #binance_client.futures_create_order(symbol='BTCUSDT',type='MARKET',side='SELL',quantity=btc_buysell)
                print("sell")
                message += "sell, wallet = "+str(getwallet("USDT"))+", the low gap was "+str(btc_prevprice/btc_min)+", btc price = "+str(btc_newprice)+"\n"
                btc_prevprice = btc_newprice
