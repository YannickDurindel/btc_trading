...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  7 12:52:59 2022
...
while True :
    try :
        ...
        elif (eth_newprice*1.001 < eth_prevprice and eth_wallet == True) or eth_wallet == "unactivated":
            if eth_crisis == False:
                t1 = time.time()
        ...
        if xrp_newprice > xrp_prevprice*1.001 and xrp_wallet == False:
            dollar += dollar * (xrp_newprice/xrp_prevprice-1)*20
            xrp_prevprice = xrp_newprice
            print("sell xrp, xrp_price =",xrp_newprice,"wallet =",dollar,'\n')
        elif (xrp_newprice*1.001 < xrp_prevprice and xrp_wallet == True) or xrp_wallet == "unactivated":
            if xrp_crisis == False:
                t1 = time.time()
        ...
        if ada_newprice > ada_prevprice*1.001 and ada_wallet == False:
            dollar += dollar * (ada_newprice/ada_prevprice-1)*20
            ada_prevprice = ada_newprice
            print("sell ada, ada_price =",ada_newprice,"wallet =",dollar,'\n')
        elif (ada_newprice*1.001 < ada_prevprice and ada_wallet == True) or ada_wallet == "unactivated":
            if ada_crisis == False:
                t1 = time.time()
        ...
        if bnb_newprice > bnb_prevprice*1.001 and bnb_wallet == False:
            dollar += dollar * (bnb_newprice/bnb_prevprice-1)*20
            bnb_prevprice = bnb_newprice
            print("sell bnb, bnb_price =",bnb_newprice,"wallet =",dollar,'\n')
        elif (bnb_newprice*1.001 < bnb_prevprice and bnb_wallet == True) or bnb_wallet == "unactivated":
            if bnb_crisis == False:
                t1 = time.time()
        ...
        if wait == False:
            ...
            while btc_wallet == False or eth_wallet == False or ada_wallet == False or xrp_wallet == False or bnb_wallet == False :
                ...
                if eth_newprice > eth_prevprice*1.0001:
                    dollar += dollar * (eth_newprice/eth_prevprice-1)*leverage
                    eth_prevprice = eth_newprice
                    print("sell ETH, eth_price =",eth_newprice,"wallet =",dollar,'\n')    
                    eth_wallet = True
                
                if ada_newprice > ada_prevprice*1.0001:
                    dollar += dollar * (ada_newprice/ada_prevprice-1)*leverage
                    ada_prevprice = ada_newprice
                    print("sell ADA, ada_price =",ada_newprice,"wallet =",dollar,'\n')    
                    ada_wallet = True
                
                if xrp_newprice > xrp_prevprice*1.0001:
                    dollar += dollar * (xrp_newprice/xrp_prevprice-1)*leverage
                    xrp_prevprice = xrp_newprice
                    print("sell XRP, xrp_price =",xrp_newprice,"wallet =",dollar,'\n')    
                    xrp_wallet = True
                
                if bnb_newprice > bnb_prevprice*1.0001:
                    dollar += dollar * (bnb_newprice/bnb_prevprice-1)*leverage
                    bnb_prevprice = bnb_newprice
                    print("sell bnb, bnb_price =",bnb_newprice,"wallet =",dollar,'\n')    
                    bnb_wallet = True
