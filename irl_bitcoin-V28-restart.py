...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 25 12:20:25 2022

@author: yannick
"""

# this one is not edited yet, copy from 26
# add a timer that le tthe code go forward when it's stuck
            ...
            while btc_new <= btc_hist :
                ...
                try:
                    if btc_new != getbitcoin() and compteur <= 100 :
                        ...
                        compteur += 1
                    elif btc_new != getbitcoin() and compteur > 100 and loss+0.0005 < interest :
                        wallet = portfolio*btc_new/1.0002
                        interest = 100*(wallet/walletinit)-100
                        loss = 100*(wallet/walletsafe)-100
                        print('buy')
